...
class ModesScreen extends StatelessWidget {
  ...
  /// Active Mode Lab library. Disabled/archived enum entries remain in the
  /// domain layer so their local score keys stay stable and can be restored.
  ...
  Widget build(BuildContext context) {
    ...
    final coreModes = <_ModeData>[
      ...
      _ModeData(
        title: 'SETTINGS',
        subtitle: 'Performance and game preferences.',
        detail: 'PERFORMANCE  •  EFFECTS  •  LOCAL DATA',
            ...
            return CustomScrollView(
              ...
              slivers: [
                SliverPadding(
                  ...
                  sliver: SliverToBoxAdapter(child: _Header(onBack: () => Navigator.of(context).pop())),
                ),
                SliverPadding(
                ...
                SliverPadding(
                  ...
                  sliver: const SliverToBoxAdapter(
                    child: _SectionTitle(title: 'CORE & UTILITIES', subtitle: 'ESTABLISHED MODES, RECORDS AND SETTINGS'),
                  ),
                ),
                SliverPadding(
                ...
                SliverPadding(
                  ...
                  sliver: SliverToBoxAdapter(
                    child: _SectionTitle(
                      title: 'MODE LAB',
                      subtitle: '${labModes.length} ENABLED VARIANTS  •  EXPERIMENTAL LIBRARY',
                    ),
                  ),
                ),
                SliverPadding(
...
class _Header extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Row(
        children: [
          IconButton(
            onPressed: onBack,
            style: IconButton.styleFrom(side: const BorderSide(color: Color(0xFF1E3552)), backgroundColor: const Color(0xFF07101E), foregroundColor: ReactColors.textPrimary),
        ...
        child: Row(
          children: [
              ...
              child: Column(
                ...
                children: [
                  FittedBox(
                    ...
                    child: Text('MODES', maxLines: 1, style: TextStyle(color: ReactColors.textPrimary, fontSize: 36, fontWeight: FontWeight.w900, letterSpacing: 1.5)),
                  ),
                  SizedBox(height: 4),
                  FittedBox(
                    fit: BoxFit.scaleDown,
                    alignment: Alignment.centerLeft,
                    child: Text('DIFFERENT RULES.  SAME REFLEXES.', maxLines: 1, style: TextStyle(color: ReactColors.textSecondary, fontSize: 9, fontWeight: FontWeight.w900, letterSpacing: 1.2)),
                  ),
                ],
              ),
            ),
            Container(
              width: 82,
              height: 82,
              decoration: BoxDecoration(shape: BoxShape.circle, border: Border.all(color: ReactColors.electricBlueBright, width: 2), boxShadow: const [BoxShadow(color: ReactColors.electricBlueBright, blurRadius: 18, spreadRadius: -10)]),
        ...
        child: InkWell(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [BoxShadow(color: data.color.withValues(alpha: .05), blurRadius: 16)],
            ),
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Row(
                  children: [
                    Container(
                      width: 44,
                      height: 44,
                      decoration: BoxDecoration(shape: BoxShape.circle, color: const Color(0xFF050A13), border: Border.all(color: data.color, width: 1.6)),
                ...
                FittedBox(
                  fit: BoxFit.scaleDown,
                  alignment: Alignment.centerLeft,
                  child: Text(data.title, maxLines: 1, style: const TextStyle(color: ReactColors.textPrimary, fontSize: 19, fontWeight: FontWeight.w900, letterSpacing: .6)),
                ),
                const SizedBox(height: 4),
                Expanded(
                  child: Align(
                    alignment: Alignment.topLeft,
                    child: Text(data.subtitle, maxLines: 2, overflow: TextOverflow.ellipsis, style: const TextStyle(color: ReactColors.textSecondary, fontSize: 10, height: 1.25, fontWeight: FontWeight.w600)),
                  ),
                ),
                  ...
                  children: [
                    Expanded(
                      child: FittedBox(
                        fit: BoxFit.scaleDown,
                        alignment: Alignment.centerLeft,
                        child: Text(data.detail, maxLines: 1, style: TextStyle(color: data.color, fontSize: 7.1, fontWeight: FontWeight.w900, letterSpacing: .45)),
                      ),
                    ),

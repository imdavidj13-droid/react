                ...
                children: [
                  ...
                  const Row(
                    children: [
                      ...
                      SizedBox(width: 9),
                      Expanded(child: _RuleCard(icon: Icons.speed_rounded, label: 'FAST', detail: 'Rapid commands')),
                      SizedBox(width: 9),
                      Expanded(child: _RuleCard(icon: Icons.remove_circle_outline_rounded, label: '-3 SEC', detail: 'Every miss')),
                    ],
                  ),
...
class _Header extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Row(children: [
        IconButton(
          onPressed: onBack,
          style: IconButton.styleFrom(backgroundColor: const Color(0xFF07101E), foregroundColor: ReactColors.textPrimary, side: const BorderSide(color: Color(0xFF213A57))),
...
class _Hero extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
        ...
        decoration: BoxDecoration(color: const Color(0xFF07111D), borderRadius: BorderRadius.circular(24), border: Border.all(color: ReactColors.coral.withValues(alpha: .55))),
        child: Row(children: [
          Container(
            width: 92,
            height: 92,
            decoration: BoxDecoration(shape: BoxShape.circle, color: const Color(0xFF050A13), border: Border.all(color: ReactColors.coral, width: 2.4)),
          ...
          const Expanded(
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              SizedBox(height: 9),
              Text('Score as many successful commands as you can in 60 seconds. A miss costs 3 seconds, but the run continues.', style: TextStyle(color: ReactColors.textSecondary, fontSize: 10.5, height: 1.35, fontWeight: FontWeight.w600)),
            ]),
          ),
        ]),
      );
...
class _RuleCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
        ...
        decoration: BoxDecoration(color: const Color(0xFF07111D), borderRadius: BorderRadius.circular(17), border: Border.all(color: ReactColors.coral.withValues(alpha: .3))),
...
class _ScorePreview extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
        ...
        decoration: BoxDecoration(color: const Color(0xFF07111D), borderRadius: BorderRadius.circular(20), border: Border.all(color: const Color(0xFF3B2A3F))),
        child: Row(children: [
          Expanded(child: _Metric(label: 'YOUR BEST', value: '$best', color: ReactColors.coral)),
          const _Divider(),
          const Expanded(child: _Metric(label: 'MISS PENALTY', value: '-3 SEC', color: ReactColors.lime)),
          const _Divider(),
          const Expanded(child: _Metric(label: 'POINTS', value: '1 / CMD', color: ReactColors.electricBlueBright)),
        ]),
      );
}
